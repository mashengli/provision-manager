...
//            DataTable1_8 total = new DataTable1_8();
//            for (int i = DATA_START_ROW_NUM; i <= DATA_END_ROW_NUM; i++) {
//                if (i - DATA_START_ROW_NUM < size) {
//                    DataTable1_8 dataTable1_8 = (DataTable1_8) dataList.get(i - DATA_START_ROW_NUM);
//                    total = ReportHelper.addData(total, dataTable1_8);
//                    for (int j = DATA_START_COLUMN_NUM; j <= DATA_END_COLUMN_NUM; j++) {
//                        BigDecimal value = getDoubleDataByColumnIndex(dataTable1_8, j);
...
//        }
     ...
     * 获取数据
     *
     * @param dataTable1_8 数据
     * @param index        下标
     */
    private static BigDecimal getDoubleDataByColumnIndex(DataTable1_8 dataTable1_8, int index) {
        switch (index) {
            case 1:
                return formatDecimal(dataTable1_8.getI01());
            case 2:
                return formatDecimal(dataTable1_8.getI02());
            case 3:
                return formatDecimal(dataTable1_8.getI03());
            case 4:
                return formatDecimal(dataTable1_8.getI04());
            default:
